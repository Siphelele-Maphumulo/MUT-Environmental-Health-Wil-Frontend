...
--
-- Table structure for table `end_of_wil_student_reflection`
--
-- Error reading structure for table environmental_health_wil_db.end_of_wil_student_reflection: #1932 - Table &#039;environmental_health_wil_db.end_of_wil_student_reflection&#039; doesn&#039;t exist in engine
-- Error reading data for table environmental_health_wil_db.end_of_wil_student_reflection: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `environmental_health_wil_db`.`end_of_wil_student_reflection`&#039; at line 1
...
CREATE TABLE `mentor` (
  ...
  `hi_number_id` int(11) DEFAULT NULL,
  `organisation_id` int(11) DEFAULT NULL,
  `first_name` varchar(250) DEFAULT NULL,
  `last_name` varchar(250) DEFAULT NULL,
  `email` varchar(320) DEFAULT NULL,
  `hashed_password` varchar(350) DEFAULT NULL,
  `capacity_at_organisation` varchar(150) DEFAULT NULL,
...
(1, '20252222@live.mut.ac.za', 'Mr', '$2b$10$zIfOFm9Ge2ltsu2AcxT1eOwGwKvGWhajQOt.MNpxAUAj.A7ZZsUIe', 'student', '2025-06-06 01:25:48', 'active'),
...
(8, '20259999@live.mut.ac.za', 'Mrs', '$2b$10$zIfOFm9Ge2ltsu2AcxT1eOwGwKvGWhajQOt.MNpxAUAj.A7ZZsUIe', 'student', '2025-06-06 01:25:48', 'active'),
...
--
-- Table structure for table `student_wil_workplace_assessment`
--

CREATE TABLE `student_wil_workplace_assessment` (
  `assessment_id` int(11) NOT NULL,
  `student_id` int(11) DEFAULT NULL,
  `mentor_id` int(11) DEFAULT NULL,
  `motivation_score` int(11) DEFAULT NULL,
  `work_habits_score` int(11) DEFAULT NULL,
  `knowledge_base_score` int(11) DEFAULT NULL,
  `communication_skills_score` int(11) DEFAULT NULL,
  `creativity_score` int(11) DEFAULT NULL,
  `adaptability_score` int(11) DEFAULT NULL,
  `average_score` decimal(3,2) GENERATED ALWAYS AS ((`motivation_score` + `work_habits_score` + `knowledge_base_score` + `communication_skills_score` + `creativity_score` + `adaptability_score`) / 6) VIRTUAL,
...
ALTER TABLE `mentor`
  ...
  ADD UNIQUE KEY `email` (`email`),
  ADD KEY `idx_mentor_organisation_id` (`organisation_id`);
...
--
-- Indexes for table `student_wil_workplace_assessment`
--
ALTER TABLE `student_wil_workplace_assessment`
  ADD PRIMARY KEY (`assessment_id`),
  ADD KEY `idx_assessment_student_id` (`student_id`),
  ADD KEY `idx_assessment_mentor_id` (`mentor_id`);
...
--
-- AUTO_INCREMENT for table `student_wil_workplace_assessment`
--
ALTER TABLE `student_wil_workplace_assessment`
