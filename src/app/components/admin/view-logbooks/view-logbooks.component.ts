...
interface Student {
  ...
  surname: string;
  student_number: string;
  level_of_study: string; // Change from number | string to just string
...
@Component({
  ...
  templateUrl: './view-logbooks.component.html',
  styleUrls: ['./view-logbooks.component.scss'],
  standalone: true,
  imports: [
    MatDatepickerModule,
    MatNativeDateModule,
...
export class ViewLogbooksComponent implements OnInit {
  students: Student[] = [];
...
// Add this new method to fetch student level from WIL applications
