...
@Component({
  selector: 'app-hpcsa-logbooks',
  templateUrl: './hpcsa-logbooks.component.html',
  styleUrl: './hpcsa-logbooks.component.scss',
  standalone: true,
  imports: [
    MatDatepickerModule,
    MatNativeDateModule,
...
export class HpcsaLogbooksComponent implements OnInit {
  students: Student[] = [];
