...
@Component({
  ...
  templateUrl: './hpcsa-logsheets.component.html',
  styleUrl: './hpcsa-logsheets.component.scss',
})
export class HpcsaLogsheetsComponent implements OnInit {
  ...
  async fetchLogSheets(): Promise<void> {
    ...
    try {
      const response = await lastValueFrom(
        ...
        this.http.get<LogSheet[]>('https://localhost:8080/api/daily-logsheets')
      );
