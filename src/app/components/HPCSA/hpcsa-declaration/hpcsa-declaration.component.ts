...
@Component({
  selector: 'app-hpcsa-declaration',
  standalone: true,
  imports: [
    MatDatepickerModule,
    MatNativeDateModule,
  ...
  templateUrl: './hpcsa-declaration.component.html',
  styleUrl: './hpcsa-declaration.component.scss'
})
export class HpcsaDeclarationComponent implements OnInit {
