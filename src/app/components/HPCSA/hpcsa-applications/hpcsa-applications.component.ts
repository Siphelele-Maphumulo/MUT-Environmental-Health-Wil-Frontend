...
import { Application, StudyLevel } from '../../admin/applications/application.model';

@Component({
  selector: 'app-hpcsa-applications',
  standalone: true,
  imports: [
    CommonModule,
    MatTableModule,
  ...
  templateUrl: './hpcsa-applications.component.html',
  styleUrl: './hpcsa-applications.component.scss'
})
export class HpcsaApplicationsComponent implements OnInit {
