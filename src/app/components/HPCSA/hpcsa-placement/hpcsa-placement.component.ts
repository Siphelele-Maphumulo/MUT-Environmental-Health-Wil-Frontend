...
@Component({
  ...
  templateUrl: './hpcsa-placement.component.html',
  styleUrl: './hpcsa-placement.component.scss'
})
export class HpcsaPlacementComponent implements OnInit {
