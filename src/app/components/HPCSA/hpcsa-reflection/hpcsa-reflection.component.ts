...
@Component({
  ...
  templateUrl: './hpcsa-reflection.component.html',
  styleUrl: './hpcsa-reflection.component.scss'
})
export class HpcsaReflectionComponent implements OnInit {
