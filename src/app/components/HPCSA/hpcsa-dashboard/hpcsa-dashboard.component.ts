...
import { UserTypeDialogComponent } from '../../admin/user-type-dialog/user-type-dialog.component';
import { AnalyticsDashboardComponent } from '../../analytics-dashboard/analytics-dashboard.component';


@Component({
  selector: 'app-hpcsa-dashboard',
  standalone: true,
  imports: [
    MatToolbarModule,
    CommonModule,
  ...
  templateUrl: './hpcsa-dashboard.component.html',
  styleUrls: ['./hpcsa-dashboard.component.scss'],
})
export class HpcsaDashboardComponent implements OnInit {
  ...
  navigateToEvents(): void {
    this.router.navigate(['/hpcsa-event'], {
      state: { from: 'hpcsa-dashboard' },
    });
  }
