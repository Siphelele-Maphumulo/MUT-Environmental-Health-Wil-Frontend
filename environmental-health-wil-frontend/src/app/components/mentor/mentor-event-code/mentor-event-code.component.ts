...
@Component({
  selector: 'app-mentor-event-code',
  imports: [
    MatToolbarModule,
    MatButtonModule,
    MatCardModule,
  ...
  templateUrl: './mentor-event-code.component.html',
  styleUrl: './mentor-event-code.component.scss'
})
export class MentorEventCodeComponent {
